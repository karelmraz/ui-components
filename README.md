...
<table>
  <tr>
    <td width="50%" valign="top">
      <a href="./dependency-graph"><img src="./docs/media/dependency-graph.png" alt="Dependency graph" /></a>
    ...
    <td width="50%" valign="top">
      <a href="./liquid-glass-login"><img src="./docs/media/liquid-glass-login.gif" alt="Liquid glass login" /></a>
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="./streak-visualizer"><img src="./docs/media/streak-visualizer.gif" alt="Streak visualizer" /></a>
    ...
    <td width="50%" valign="top">
      <a href="./interactive-globe"><img src="./docs/media/interactive-globe.gif" alt="Interactive globe" /></a>
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="./spotify-clone"><img src="./docs/media/spotify-clone.gif" alt="Spotify clone" /></a>
    ...
    <td width="50%" valign="top">
      <a href="./ai-chat-orb"><img src="./docs/media/ai-chat-orb.gif" alt="AI chat orb" /></a>
